...
public class Automobile implements Serializable{
	...
	/*
	 * get all option sets name
	 * @return	the name of all option set
	 * */
	public Set<String> getOptionSetsName(){
		Set<String> optionSetsName = new HashSet<String>();
		for(OptionSet optionSet : this.optionSets){
			optionSetsName.add(optionSet.getName());
		}
		return optionSetsName;
	}
	
	public String toString(){
		StringBuilder sb = new StringBuilder();
		sb.append("The detailed information of this car: \n");
		sb.append("\tModel name: " + this.name + "\n");
		sb.append("\tMake: " + this.make + "\n");
		for(OptionSet optionSet : this.optionSets){
			sb.append("\t" + optionSet.getName() + ": \n");
			Set<String> options = optionSet.getOptions();
			for(String option : options){
				sb.append("\t\t" + option + "\n");
			}
			sb.append("\t\tOption choice: " + optionSet.getOptioinChoice().getName() + "\n");
		}
		return sb.toString();
	}
	
	/*
	 * get the options of one option set
	 * @param	optionSet
	 * 			the option set name
	 * 
	 * @return	the set of options' name
	 * */
	public Set<String> getOptions(String optionSet){
		return this.findOptionSetWithName(optionSet).getOptions();
	}
}